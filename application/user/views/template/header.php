...
<?php echo $seo_ga_script; ?>
        ...
        <script type="text/javascript">
            ...
            (function () {
                ...
                po.src = '//192.168.0.118:8080/zcodialawfirm/ztchat/index.php/chat/getstatus/(click)/internal/(position)/bottom_right/(ma)/br/(top)/350/(units)/pixels/(leaveamessage)/true?r=' + referrer + '&l=' + location;
