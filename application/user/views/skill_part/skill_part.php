                            ...
                            foreach ($attorney_skill_types as $key => $value) {
                                ...
                                <div class="progressbar-wrapper">
                                    <div class="progress vertical bottom">
                                        <div class="progress-bar six-sec-ease-in-out" data-bg-image="<?php echo $value['atty_st_image']; ?>" role="progressbar" data-transitiongoal="<?php echo $value['atty_st_goal']; ?>"></div>
                                    </div>
