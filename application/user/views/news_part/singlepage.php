...
if (isset($single_page) && !empty($single_page)) {
    ...
    $category_tag = $single_page['category_tag'];
    if (isset($category_tag) && !empty($category_tag)) {
        if (sizeof($category_tag) > 1) {

            $category_tag = $category_tag[sizeof($category_tag) - 1];
        } else {
                ...
                <div class="col-xs-12 col-md-12 justify-content">
                    ...
                    <article class="post-detail post-408 post type-post status-publish format-quote has-post-thumbnail hentry category-travel tag-fruity tag-overreact tag-trouble tag-twice post_format-post-format-quote">
                        ...
                        <div class="social ">
                            ...
                            <ul>
                                <li><a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo 'http://192.168.0.118:8080' . $_SERVER['REQUEST_URI']; ?>" target="_blank" class="facebook"><i class="fa fa-facebook"></i></a></li>
                        ...
                        <header class="post-head">
                            ...
                            <aside class="post-meta">
                                ...
                                </a> <a href="javascript:void(0);" class="post-category category-link-bg-5" ><?php echo $category_tag; ?></a>
                                <a href="news/view_news" class="btn-back" data-animate="fadeInUp">Back to News</a>
                            </aside>
                        </header>
