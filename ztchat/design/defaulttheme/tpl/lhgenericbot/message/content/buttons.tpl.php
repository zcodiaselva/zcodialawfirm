...
<?php else : ?>
<div class="msg-body"><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('genericbot/list','Could not call')?> <?php echo htmlspecialchars($metaMessage['render_function'])?> <?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('genericbot/list','with args')?> <?php echo htmlspecialchars($metaMessage['render_args'])?></div>
<?php endif; ?>
