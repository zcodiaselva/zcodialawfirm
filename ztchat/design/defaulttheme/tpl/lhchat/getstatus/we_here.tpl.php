...
if (!this.cssNHWasAdded) {
	...
	<?php else : ?>
        ...
        '#<?php echo $chatCSSPrefix?>_need_help_triangle{width: 0;height: 0;border-left: 20px solid transparent;border-right: 10px solid transparent;border-top: 15px solid #<?php $theme !== false ? print $theme->need_help_bcolor : print '212529' ?>;position:absolute;bottom:-14px;}'+
