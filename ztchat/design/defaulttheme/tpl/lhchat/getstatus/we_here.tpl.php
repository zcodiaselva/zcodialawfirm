...
if (!this.cssNHWasAdded) {
	...
	<?php else : ?>
        var raw_css_need_hl = '#<?php echo $chatCSSPrefix?>_need_help_container{<?php if ($theme !== false && $theme->show_need_help_delay > 0) : ?>display:none;<?php endif;?>width:235px;border-radius:30px;background:#<?php $theme !== false ? print $theme->need_help_bcolor : print '0c8fc4' ?>;position:absolute;color:#<?php $theme !== false ? print $theme->need_help_tcolor : print 'ffffff' ?>;padding:10px;border:1px solid #<?php $theme !== false ? print $theme->need_help_border : print '3ca5d0' ?>;margin-top:-105px;}#<?php echo $chatCSSPrefix?>_need_help_container:hover{background-color:#<?php $theme !== false ? print $theme->need_help_hover_bg : print '3ca5d0' ?>}#<?php echo $chatCSSPrefix?>_need_help_container:hover #<?php echo $chatCSSPrefix?>_need_help_triangle{border-top-color:#<?php $theme !== false ? print $theme->need_help_hover_bg : print '3ca5d0' ?>}'+
        '#<?php echo $chatCSSPrefix?>_need_help_triangle{width: 0;height: 0;border-left: 20px solid transparent;border-right: 10px solid transparent;border-top: 15px solid #<?php $theme !== false ? print $theme->need_help_bcolor : print '0c8fc4' ?>;position:absolute;bottom:-14px;}'+
