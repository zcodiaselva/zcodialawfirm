...
<?php elseif (in_array($position, array_keys($positionArgument))) : ?>
    ...
    <?php else : ?>
    var statusTEXT = '<a id="'+(this.isOnline == true ? 'online-icon' : 'offline-icon')+'" class="status-icon" href="#" onclick="return lh_inst.lh_openchatWindow()" ></a>';
